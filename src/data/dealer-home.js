...
// а не из мастера — он у всех трёх строк один и тот же. «Рекомендованая» —
// орфография дизайнера. min=50 — из подписи «Минимальная наценка 50%»
// (2225:165661). В Blade это @foreach по прайс-листам с сервера.
