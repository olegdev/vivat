...
// Адрес самовывоза по городу «Ваш регион». В макете есть только московский
// (1209:95263), остальные — заглушки, помеченные как заглушки, чтобы смена
// города была видна; в Blade это ответ сервера по выбранному городу.
export const PICKUP_ADDRESS = {
  Москва: "16-й км МКАД, 50 метров от внешней стороны, ул. Энергетиков",
  "Санкт-Петербург": "[адрес-заглушка] Санкт-Петербург, Складская ул., 1",
  "Нижний Новгород": "[адрес-заглушка] Нижний Новгород, Складская ул., 1",
  "Ростов-на-Дону": "[адрес-заглушка] Ростов-на-Дону, Складская ул., 1",
  Рязань: "[адрес-заглушка] Рязань, Складская ул., 1",
};
