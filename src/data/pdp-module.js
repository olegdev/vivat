...
export const product = {
  // Ключ для корзины — см. data/pdp.js.
  id: "flet-shkaf-nizhniy-2d",
  ...
  // Цена — решение клиента: в макете модуля её нет (см. BACKLOG.md).
  price: "43 335₽",
  oldPrice: "48 200₽",
  discount: "- 10%",
...
// Комплектация модуля — фикстура, чтобы вкладка не была пустой (клиент,
// 15.09): таблицы модуля в макете нет, строки — упаковки этого шкафа.
export const packageRows = [
  { name: "Каркас нижнего шкафа Н 600 (упак.)", size: "816*800*478", weight: "18.412", volume: "0.03104", qty: "1" },
  { name: "Фасад Флэт Cashmere 716*396 (упак.)", size: "716*396*22", weight: "4.305", volume: "0.00624", qty: "2" },
  { name: "Комплект фурнитуры (упак.)", size: "120*300*200", weight: "1.150", volume: "0.00720", qty: "1" },
];
