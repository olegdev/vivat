...
import { SCHEME_TREE } from "../../data/schemes.js";

// «Схемы сборки» — контентная страница дилерского раздела.
...
// ---- меню раздела -----------------------------------------------------------
renderMenuB2b(MENU_B2B, { current: "schemes.html" });

// ---- дерево документов ------------------------------------------------------
renderDocTree(document.querySelector("[data-doc-tree]"), SCHEME_TREE);
