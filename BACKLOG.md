...
- **Прайс-листы «Оптовая цена»** — в раскладке инстанса есть только триггер
  132×24: ни списка, ни его строк. Прототипных данных в экспорте нет вообще.
  Выпадающий список был выдуман и удалён; сейчас это текст с пунктиром и
  шевроном, ни к чему не привязанный. Нужны: что открывается по шеврону и
  какие в списке пункты.
